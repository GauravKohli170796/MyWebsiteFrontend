...
function SideNavbar({bNavbarShow}) {
    return (
        ...
        <ul>
            ...
            <li><div className="navIcons"><FaCalculator></FaCalculator></div><NavLink  exact activeClassName="active" className="link"  to="/Horoscope/LoveCalculator">Love Calculator</NavLink></li>
